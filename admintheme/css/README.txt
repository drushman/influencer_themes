...
To use these stylesheets, rename the files and admintheme with the name of your theme.
...
admintheme-alpha-default-narrow.css  
...
admintheme-alpha-default-normal.css
...
admintheme-alpha-default-wide.css
